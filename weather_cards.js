...
function getWea(cap) {
    var api2 = "https://api.openweathermap.org/data/2.5/weather?q=" + cap + "&units=metric&appid=016e201974c971969227a9c2123b81f7";
    fetch(api2)
        .then(function (data1) {
            return data1.json()
        })
